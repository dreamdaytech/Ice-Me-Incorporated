...
export default function Navbar() {
  ...
  return (
    <nav className="w-full sticky top-0 z-50 bg-white/70 backdrop-blur-xl shadow-[0_20px_40px_rgba(0,26,56,0.05)]">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 md:px-8 py-4 md:py-6">
        ...
        {/* Desktop Navigation */}
        <div className="hidden md:flex space-x-8 font-bold tracking-tight">
          {navLinks.map((link) => {
        ...
        {/* Mobile Menu Toggle */}
        <button 
          className="md:hidden z-50 relative p-2 text-primary hover:bg-surface-container rounded-full transition-colors"
